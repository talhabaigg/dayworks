...
return new class extends Migration
{
    ...
    {
        Schema::create('daywork_order_items', function (Blueprint $table) {
            ...
            $table->string('item_code'); // Assuming a string data type for item_code, adjust as needed
            $table->integer('qty');
    ...
    {
        Schema::dropIfExists('daywork_order_items');
    }
};
